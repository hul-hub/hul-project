  ...
  <div class="tab-container">
    <div class="search marginTwo">
      <el-row type="flex" align="center">
        <el-col :span="6">
          <span class="detail-title">{{id?"编辑服务商":"新增服务商"}}</span>
        </el-col>
        <el-col :span="18">
    ...
    <div>
      <el-tabs type="border-card" :value="activeName">
        <el-tab-pane label="服务商信息" name="1" disabled>
          <el-form
        ...
        <el-tab-pane label="营业信息" name="2" disabled>
          ...
          >
            ...
            <el-row :gutter="36">
              <el-col :span="8">
                <el-form-item label="营业执照:" ref="slicenes">
                  <upload-file
              ...
              <el-col :span="8">
                <el-form-item label="税务登记证:" ref="tax">
                  <upload-file
                    :param="taximg"
              ...
              <el-col :span="8">
                <el-form-item label="组织机构代码证:" ref="orgImg">
                  <upload-file
            ...
            <div v-if="iscontactstype">
              ...
              <el-row :gutter="36">
                <el-col :span="24">
                  <el-form-item label="身份证有效期:">
                    <el-date-picker
                      v-model="contactsItem.idvalidstartdate"
                      type="date"
                      value-format="yyyy-MM-dd"
                      placeholder="开始日期"
                    ></el-date-picker>
                    <span>-</span>
                    <el-date-picker
                      v-model="contactsItem.idvalidenddate"
                      value-format="yyyy-MM-dd"
                      type="date"
                      placeholder="结束日期"
                    ></el-date-picker>
              ...
              <el-row :gutter="36">
                <el-col :span="8">
                  <el-form-item label="身份证正面:" prop="conidfrontimg">
                    <upload-file
                      :param="conidfrontimg"
                ...
                <el-col :span="8">
                  <el-form-item label="身份证反面:" prop="conidbackimg">
                    <upload-file
                      :param="conidbackimg"
  ...
  data() {
    return {
      ...
      serviceMerchantItemRules: {
        ...
        upserprocode: [
          { required: true, message: "请输入所属服务商", trigger: "change" }
        ],
        serprotype: [
  ...
  methods: {
    ...
    okFun() {
      ...
      that.$refs.contactsItem.validate(async valid => {
        if (valid) {
          ...
          params["serprolevel"] =
            that.serviceMerchantItem.serprolevel == "-"
              ? ""
              : that.serviceMerchantItem.serprolevel;
          ...
          // params["serProImage.serproagreementimg"] =
          //   that.shopItem.serproagreementimg;
    ...
    changecontactstype(val) {
      ...
      if (val == 2) {
        ...
        that.contactsItem.idvalidstartdate = that.legalItem.idvalidstartdate;
        that.contactsItem.idvalidenddate = that.legalItem.idvalidenddate;
    ...
    upserprocodeFun(val) {
      ...
      that.serviceMerchantItem.serprotype = "1" + (item[0].serprolevel + 1);
